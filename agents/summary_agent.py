...
class SummaryAgent:
            ...
            [
                (
                    ...
                    (
                        ...
                        "Do not invent facts or speculate beyond the given data. "
                        "Provide a long answer covering everything that answers the question. "
                        "(for example, aim for a few well-structured paragraphs that cover all "
                        "important points needed to answer the question)."
                        "Explain what is asked in DETAIL."
                        "Answer in such a way that you are the one who searched the answers and the sources."
                        "DO NOT mention 'based on provided data', 'provided information', 'provided sources' or anything similar to that."
                    ),
                ),
                (
                    "human",
                    (
                        ...
                        "Data:\n{sources_block}\n\n"
                        "Instructions:\n"
                        "- Fully answer the QUESTION using ONLY the data above.\n"
    ...
    def summarize_from_judge(
        ...
        meta_memory_manager = MetaMemoryManager()
        meta_memory_manager.dispatch(answer_with_sources)
