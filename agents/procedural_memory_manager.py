...
class ProceduralMemoryManager():
    def __init__(self):
        ...
        self.llm_embed = GoogleGenerativeAIEmbeddings(model='models/gemini-embedding-001',google_api_key=os.getenv("GOOGLE_API_KEY"))
        self.db = Chroma(collection_name='procedural_memory',
                    persist_directory="./database/procedural_db",
