...
class Semantic(BaseModel):
    ...
    summary: str
    details: str
    source: str = Field(description='Links to the sources of the information')

# class of SemanticMemoryManager
class SemanticMemoryManager:

    def __init__(self, db_path="./database/semantic_db"):
        ...
        template = """
Extract semantic facts and links/sources (if available) from the user's message.
